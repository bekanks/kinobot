...
define('API_KEY', getenv('7588512573:AAF3O5LpLgr1oI_vDBtbPMktD0R1Gt3T1Go'));

$idbot = 7588512573;
$umidjon = getenv('6998927102');
$owners = array($umidjon);
$user = "berikganiev";
$bot=bot(getMe)->result->username;

// Mana bu to'g'ri variant:

define('DB_HOST', getenv('DB_HOST'));
define('DB_USER', 'if0_39550739'); // Buni o'zgartirmaymiz, bu maxfiy emas
define('DB_PASS', getenv('DB_PASSWORD'));
define('DB_NAME', 'if0_39550739_kinoplushd'); // Bu ham maxfiy emas
